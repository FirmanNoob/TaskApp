    ...
    <div class="row">
        <div class="col-md-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br>
                    <form class="form-label-left input_mask" action="/profile/{{$data->id}}/update" method="POST">
                        {{csrf_field()}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-sm-9 ">
                                <input type="password" class="form-control" name="password" placeholder="Masukan Password..." value="{{$data->password}}">
                            </div>
                        </div>
                        <div class="form-group row">
