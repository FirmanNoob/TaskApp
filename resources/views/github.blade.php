        ...
        <nav class="bg-gray-900 text-white px-4 py-3 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4 text-white">
                <a href="#" class="relative hover:text-gray-400">
                    <svg class="w-5" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="#" class="flex items-center hover:text-gray-400">
                    ...
                    <svg class="w-3 ml-1" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="repo-stats flex flex-col lg:flex-row items-center justify-between px-8 py-4">
            ...
            <div class="flex space-x-2 mt-4 lg:mt-0">
                <div class="flex text-xs">
                    <button class="border border-gray-400 rounded rounded-r-none px-3 py-1 hover:bg-gray-200 flex items-center space-x-1">
                    ...
                    <a href="#" class="border border-gray-400 rounded rounded-l-none border-l-0 font-semibold hover:text-blue-600 px-3 py-1">430</a>
                </div>
                <div class="flex text-xs">
                    <button class="border border-gray-400 rounded rounded-r-none px-3 py-1 hover:bg-gray-200 flex items-center space-x-1">
                    ...
                    <a href="#" class="border border-gray-400 border-l-0 rounded rounded-l-none font-semibold px-3 py-1 hover:text-blue-600">25.3k</a>
                </div>
                <div class="flex text-xs">
                    <button class="border border-gray-400 rounded rounded-r-none px-3 py-1 hover:bg-gray-200 flex items-center space-x-1">
                        <svg class="fill-current text-gray-600 w-4" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true">
                            <path fill-rule="evenodd" d="M5 3.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm0 2.122a2.25 2.25 0 10-1.5 0v.878A2.25 2.25 0 005.75 8.5h1.5v2.128a2.251 2.251 0 101.5 0V8.5h1.5a2.25 2.25 0 002.25-2.25v-.878a2.25 2.25 0 10-1.5 0v.878a.75.75 0 01-.75.75h-4.5A.75.75 0 015 6.25v-.878zm3.75 7.378a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm3-8.75a.75.75 0 100-1.5.75.75 0 000 1.5z"></path>
                        </svg>
                        <div class="">Fork</div>
                    </button>
                    <a href="#" class="border border-gray-400 border-l-0 rounded rounded-l-none font-semibold px-3 py-1 hover:text-blue-600">1.2k</a>
                </div>
            </div>
        </div> <!-- end repo-stats -->
        ...
        <ul class="repo-nav border-b border-gray-400 flex items-center px-8 mt-4">
            <li class="font-semibold">
                <a href="#" class="flex items-center border-b-2 border-red-500 px-4 pb-3">
                    <svg class="w-4 fill-current" classes="UnderlineNav-octicon" display="none inline" viewBox="0 0 16 16" version="1.1" width="16" aria-hidden="true">
            ...
            <li>
                <a href="#" class="flex items-center border-b-2 border-transparent hover:border-gray-400 transition ease-in-out duration-150 px-4 pb-3">
                    <svg class="w-4 fill-current text-gray-600" classes="UnderlineNav-octicon" display="none inline" viewBox="0 0 16 16" aria-hidden="true">
            ...
            <li>
                <a href="#" class="flex items-center border-b-2 border-transparent px-4 pb-3 hover:border-gray-400 transition ease-in duration-150">
                    <svg class="w-4 fill-current text-gray-600" classes="UnderlineNav-octicon" display="none inline" viewBox="0 0 16 16" version="1.1" width="16" aria-hidden="true">
                ...
                <div class="branch-navigation flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        <button class="border border-gray-400 rounded-md px-4 py-1 hover:bg-gray-200 flex items-center space-x-2">
                            <svg class="fill-current text-gray-600 w-4" text="gray" viewBox="0 0 16 16" version="1.1" width="16" aria-hidden="true">
                        ...
                        <a href="#" class="hidden lg:flex items-center space-x-2 py-1 group">
                            <svg class="fill-current text-gray-600 group-hover:text-blue-600 w-4" text="gray" viewBox="0 0 16 16" version="1.1" width="16" aria-hidden="true">
                                <path fill-rule="evenodd" d="M11.75 2.5a.75.75 0 100 1.5.75.75 0 000-1.5zm-2.25.75a2.25 2.25 0 113 2.122V6A2.5 2.5 0 0110 8.5H6a1 1 0 00-1 1v1.128a2.251 2.251 0 11-1.5 0V5.372a2.25 2.25 0 111.5 0v1.836A2.492 2.492 0 016 7h4a1 1 0 001-1v-.628A2.25 2.25 0 019.5 3.25zM4.25 12a.75.75 0 100 1.5.75.75 0 000-1.5zM3.5 3.25a.75.75 0 111.5 0 .75.75 0 01-1.5 0z"></path>
                            </svg>
                    ...
                    <div class="hidden lg:flex items-center space-x-2">
                        ...
                        <button class="focus:outline-none border border-gray-400 rounded-md px-3 py-1 hover:bg-gray-200 flex items-center space-x-1">
                            <div class="font-semibold">Add file</div>
                            <svg class="w-4" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                            </svg>
                        </button>
                        <button class="focus:outline-none font-semibold border border-gray-400 rounded-md text-white bg-green-600 hover:bg-green-700 px-4 py-1 flex items-center space-x-2">
                            <svg class="animate-spin w-4 fill-current text-gray-200" viewBox="0 0 16 16" aria-hidden="true">
                ...
                <div class="commits-container bg-blue-100 rounded-md rounded-b-none border border-blue-200 border-b-0 flex items-center justify-between px-4 py-4 mt-5">
                    ...
                    <div class="flex items-end">
                        ...
                        <a href="#" class="flex items-center ml-3">
                            <svg class="w-4 fill-current text-gray-600" text="gray" viewBox="0 0 16 16" version="1.1" aria-hidden="true">
                ...
                <div class="file-explorer rounded-md rounded-t-none border border-gray-400 text-gray-700 divide-y divide-gray-400">
                    <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
                        <div class="w-4/12 flex items-center">
                            <svg class="w-4 fill-current text-blue-400" color="blue-3" aria-label="Directory" viewBox="0 0 16 16" role="img">
                    ...
                    <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
                        <div class="w-4/12 flex items-center">
                            <svg class="w-4 fill-current text-gray-600" color="gray-light" aria-label="File" viewBox="0 0 16 16" role="img">
            ...
            <div class="sidebar w-full lg:w-1/4">
                <div class="about mt-4 lg:mt-0">
                    ...
                    <a href="#" class="flex items-center space-x-2 mt-4 group">
                        <svg class="w-4 fill-current text-gray-600 group-hover:text-blue-600" mr="2" viewBox="0 0 16 16" aria-hidden="true">
                ...
                <div class="releases border-t border-gray-400 mt-6 pt-6">
                    ...
                    <a href="#" class="flex items-start mt-4 group">
                        <svg class="fill-current mt-1 w-4 text-green-500 group-hover:text-blue-500" mt="1" classes="flex-shrink-0" color="green" viewBox="0 0 16 16" aria-hidden="true">
                            <path fill-rule="evenodd" d="M2.5 7.775V2.75a.25.25 0 01.25-.25h5.025a.25.25 0 01.177.073l6.25 6.25a.25.25 0 010 .354l-5.025 5.025a.25.25 0 01-.354 0l-6.25-6.25a.25.25 0 01-.073-.177zm-1.5 0V2.75C1 1.784 1.784 1 2.75 1h5.025c.464 0 .91.184 1.238.513l6.25 6.25a1.75 1.75 0 010 2.474l-5.026 5.026a1.75 1.75 0 01-2.474 0l-6.25-6.25A1.75 1.75 0 011 7.775zM6 5a1 1 0 100 2 1 1 0 000-2z"></path>
                        </svg>
                        <span class="ml-2">
